...
DXが必要な人の役に立ちたい思いからフリーランス活動始めました。(ココナラ）

https://coconala.com/services/3728537

#### ココナラ実績

 ①地方の〇〇株式会社に作成支援させて頂きました。
 
内容: ビデオ通話3回 チャットで技術支援

デスクトップフロー内容: リモートデスクトップ環境下において画像認識、

キー送信メインながらExcelからデータをシステムに繰り返して入力、

エラーハンドリングあり、RDP用のPowerAutomate Desktop エージェントを導入支援、
Windows11の操作

など複数支援しました。

② WEB スクレイピング 7000 件をExcelに転記

③Outlook受信ボックスの整理整頓、添付ファイル保存などです。
④Outlook受信ボックス→動的な本文のURL抽出→WEBシステムのダウンロードを開発支援
